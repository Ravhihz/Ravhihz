...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Full-stack complaint management system with real-time notifications and role-based access control.</p>
      <p>
      ...
      <ul>
        <li>Multi-role access control system</li>
        <li>RESTful API + real-time notifications</li>
        <li>Scalable backend architecture</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>🧠 <a href="https://github.com/Ravhihz/GoFusion">GoFusion</a></h3>
      <p>NLP-based sentiment analysis platform for Indonesian social media using custom ML models.</p>
      <p>
...
**⚡ Available for entry-level roles & freelance projects**
